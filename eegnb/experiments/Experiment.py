...
class BaseExperiment(ABC):
    ...
    def _run_frame_locked_trial_loop(self, frames_on: int, frames_off: int):
        ...
        # Same OS frame-pacing guard the time-based loop uses (#326): raises
        # scheduler tick / process priority and suspends GC for the duration.
        # Frame-locked paradigms (FPVS, RSVP) need this most — a GC pause or a
        # scheduler slip mid-cycle lands an image one vblank late.
        with high_priority_section():
