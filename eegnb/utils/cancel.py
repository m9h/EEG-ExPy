...
Replaces pynput.keyboard.Listener for the simple case of "give the user N
seconds to press a key and Enter to cancel an operation". Uses a daemon
thread reading from stdin so it works on Linux/macOS/Windows and in
terminals without a DISPLAY.
"""
